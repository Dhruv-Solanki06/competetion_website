...
export default function Home() {
  const [activeSection, setActiveSection] = useState("about-jyot");
  ...
  useEffect(() => {
    const sections = ["about-jyot", "categories", "contact"];
    const handleScroll = () => {
      const current = sections.find((id) => {
        const el = document.getElementById(id);
        if (!el) return false;
        const rect = el.getBoundingClientRect();
        // top is near header height; marks as active when the section header hits ~100px from top
        return rect.top <= 110 && rect.bottom > 110;
      });
      if (current) setActiveSection(current);
    };

    // Run once so the correct nav item is highlighted on first render
    handleScroll();
    window.addEventListener("scroll", handleScroll, { passive: true });
    return () => window.removeEventListener("scroll", handleScroll);
  }, []);

  // ------- Register Modal (single, consolidated version) -------
  const Register = () => {
    ...
    const handleSubmit = () => {
      const { name, email, phone, institution } = formData;
      if (!name || !email || !phone || !institution) {
        alert("Please fill all required fields (Name, Email, Phone, Institution).");
        return;
      }
    ...
    return (
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Sacred Expression Registration"
      >
        <div className="bg-white shadow-2xl rounded-3xl p-10 w-full max-w-lg relative border border-gray-100">
          <button
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-red-700 mb-2">Sacred Expression Registration</h1>
          ...
          <div className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-2">Competition Category (optional)</label>
              <select
        ...
        <div className="max-w-7xl mx-auto px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <button
                onClick={() => scrollToSection("about-jyot")}
                className={`text-sm font-medium transition-colors ${
                  activeSection === "about-jyot" ? "text-red-600" : "text-gray-700 hover:text-red-600"
                }`}
              >
                ABOUT
              </button>
              <button
                ...
                className={`text-sm font-medium transition-colors ${
                  activeSection === "categories" ? "text-red-600" : "text-gray-700 hover:text-red-600"
                }`}
              >
                CATEGORIES
              </button>
              <button
                ...
                className={`text-sm font-medium transition-colors ${
                  activeSection === "contact" ? "text-red-600" : "text-gray-700 hover:text-red-600"
                }`}
              >
                CONTACT
              </button>
            ...
            <button
              ...
              className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5"
            >
              REGISTER NOW
            </button>
          </div>
      ...
      <section className="pt-24 pb-16 bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <div className="mb-12">
              <h1 className="text-6xl md:text-8xl font-black text-red-700 mb-4 tracking-tight">VASUDHAIVA</h1>
              <h1 className="text-6xl md:text-8xl font-black text-red-700 mb-6 tracking-tight">KUTUMBAKAM</h1>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-gray-200">
              ...
              <p className="text-lg text-gray-700 leading-relaxed text-center mb-8">
                Jyot is thrilled to unveil the <strong>4th edition</strong> of its flagship conclave series, Vasudhaiva
                Kutumbakam ki Oar, which is set to take place in <strong>January 2026</strong>, spanning a week in the
                bustling financial capital of Mumbai. We also envision an immersive and interactive exhibition that
                showcases the confluence of ancient Indian wisdom and modern global perspectives.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed text-center">
                Building on the remarkable successes of our previous three conclaves, this edition promises a grander
                scale, broader reach, and deeper impact. The theme for this edition of the conclave is{" "}
                <strong>Sankraman Kaal</strong>.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group">
              <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-2xl p-8 h-full border border-red-200 group-hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Rooted in timeless teachings from Jain, Hindu, and Buddhist scriptures, offering solutions for
                  contemporary global challenges through spiritual understanding.
                </p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-amber-50 to-amber-100 rounded-2xl p-8 h-full border border-amber-200 group-hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Multiple artistic mediums to express the profound concept of global family through songs, poetry,
                  stories, and visual arts in diverse categories.
                </p>
              </div>
            </div>
            ...
            <div className="group">
              <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 h-full border border-green-200 group-hover:shadow-xl transition-all duration-300">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Promoting harmony between modern lifestyle and ancient thought, fostering peace, tolerance, and global
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              The eternal flame of wisdom lighting the path to global harmony through ancient teachings and modern
              applications
            </p>
          </div>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
              <div className="text-center mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center mb-6 mx-auto shadow-lg">
                  <Image src={jyotimage} alt="Jyot Initiative logo" width={64} height={64} className="rounded-full" />
                </div>
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  Jyot represents the sacred flame of knowledge that has been burning since time immemorial, carrying
                  the wisdom of our ancestors forward to illuminate the path for future generations.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Through cultural preservation, spiritual education, and universal brotherhood promotion, Jyot creates
                  a world guided by Vasudhaiva Kutumbakam principles.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100">
              <div className="text-center mb-8">
                <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-red-700 rounded-full flex items-center justify-center mb-6 mx-auto shadow-lg">
                  <Image src={jyotimage} alt="Vasudhaiva Kutumbakam emblem" width={64} height={64} className="rounded-full" />
                </div>
              ...
              <div className="space-y-4">
                <p className="text-gray-700 leading-relaxed">
                  A renaissance of ancient Indian wisdom, establishing a world order based on the profound teaching that
                  all humanity constitutes one universal family.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Rooted in Maha Upanishad&apos;s wisdom, addressing contemporary challenges through compassion, unity,
                  and shared responsibility for our collective future.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-red-100 leading-relaxed mb-8">
              ...
              collective spiritual evolution. Your creative expression can bridge ancient wisdom with modern
              understanding.
            </p>
          </div>
